            ...
            [
                [
                    InlineKeyboardButton(
                        "• نـصـب بـوتك مـن هـنا •", url="https://t.me/ektesa7",
                    )
                ],
...
async def start(client: Client, message: Message):
    await message.reply_photo(
        photo=f"https://telegra.ph/file/e33dc29410b1b49961a9b.jpg",
        caption=f"""اهلا وسهلا بك في سورس برق مميزات السورس قويه وفريده يمكنك امتلاك بوت كامل حقوقك قوم بمراسلة مطور السورس""",
        reply_markup=InlineKeyboardMarkup(
         [
            [
                InlineKeyboardButton("قناة السورس الرسمية", url=f"https://t.me/ektesa7"),
            ],
            [
                InlineKeyboardButton(
                    "مطور السورس", url=f"https://t.me/dddfx0"
                ),
            ],
            [
...
async def help(client: Client, message: Message):
    await message.reply_photo(
        ...
        reply_markup=InlineKeyboardMarkup(
         [
            [
                InlineKeyboardButton("مطور السورس", url=f"https://t.me/dddfx0"),
            ],
            [
                InlineKeyboardButton(
